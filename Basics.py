...
imgTrain = face_recognition.load_image_file('ImagesBasic/Aksh.jpg')
imgTrain = cv2.cvtColor(imgTrain,cv2.COLOR_BGR2RGB)

imgTest = face_recognition.load_image_file('ImagesBasic/Aksh test.jpg')
...
cv2.imshow('Aksh',imgTrain)
cv2.imshow('Aksh Test',imgTest)
cv2.waitKey(0)